...
import 'package:frontend/models/requests/login_request.dart';
import 'package:frontend/models/requests/register_request.dart';
...
class AuthRepository extends BaseAuthRepository {
  ...
  Future<AppResponse> logout() async {
    final response = await _dioClient.post(Endpoints.logout);
